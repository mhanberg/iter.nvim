...
This is merely a polyfill package for `vim.iter`, which is currently only available Neovim v0.10 (which at the time of writing, is no yet released).

Copied from SHA f56c1848091bb64c63b5bc25ec74bcbd2f52bdde.

The license belongs entirely to Neovim.
